...
class BgPlaneSpark2{
    ...
    entryAnimate(target,target2){
      ...
      const speed= Math.random()*2000+4000;
      this.object.position.set(2600+Math.random() * 200, -600-Math.random() * 100,0.3)  
      ...
      // .easing(TWEEN.Easing.Linear.None)
         ...
         .start()
         .onComplete( ()=> {
             this.object.position.set(2600+Math.random() * 200, -400-Math.random() * 400,0.3) 
             this.object.scale.set(0.6,0.6,0.6);
             tl2.delay(1100).start()
      })
