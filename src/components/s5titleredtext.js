...
class S5TitleRedText{
    ...
    init() {
        ...
        fontloader.load( 'fonts/Inter_Tight_Medium.json',    ( font )=> {
    ...
    addText =(font, material)=>{
      ...
      let message = 'PROJECT HIGHLIGHTS';
      let shapes = font.generateShapes( message, 32 );
    ...
    // geometry.translate( xMid,0, 0 );
      ...
      this.object1.position.set(584,150,0.4)
    ...
    //   console.log(this.object)   
      ...
      this.scene.add(this.object);
       this.entryAnimate(new THREE.Vector3(2200,0,0.4),new THREE.Vector3(0,0,0.4),new THREE.Vector3(1600,0,0.4))
    ...
    entryAnimate(start,target,target2){
      //   console.log (this.object)
         ...
         .delay(0+this.slower)
         .to( {x: target.x, y:target.y, z:target.z},1400+this.slower)
       //  .yoyo(true)
        // .repeat(Infinity)
